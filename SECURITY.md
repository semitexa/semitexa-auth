...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-auth/security/advisories/new).
...
In scope: anything in `semitexa/auth` that lets a request, a job or a message do
